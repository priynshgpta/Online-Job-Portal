...
<meta charset="UTF-8">
  ...
  <nav class="navbar navbar-expand-lg navbar-light">
    <a class="navbar-brand" href="#"><img src="images/jobportal.png" alt="" class="img-fluid" width="80px">Recent Jobs</a>
...
<body>
    <div class="container mt-5 content">
        <?php
        // Fetch recent jobs
        $query = "SELECT * FROM jobs JOIN employer ON jobs.eid = employer.eid ORDER BY date_posted DESC LIMIT 10";
        $result = mysqli_query($db1, $query);

        if (mysqli_num_rows($result) == 0) {
            echo "<div class='alert alert-info' role='alert'>
                    <p style='font-size: 20px'><strong>No recent jobs available.</strong></p>
                  </div>";
        } else {
            echo "<h3 style='color:green'> Recent Jobs </h3>";
