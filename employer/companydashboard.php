...
<div class="container mt-4">
		...
		<hr>
			...
			<p>Recents job post below to take actions.</p>
			<?php
				$conn = mysqli_connect('localhost:3306', 'root', '', 'jobportal');
				...
				$sql = "SELECT jobid,eid,title, jobdesc, vacno, experience, location, industry from jobs";
				$result = mysqli_query($conn, $sql);
				
				if(mysqli_affected_rows($conn)>0) {
					for($i = 0; $i < mysqli_num_rows($result); $i++){
						$row = mysqli_fetch_assoc($result);
						echo '<a><div class="card">';
						echo '<h4><b>'.$row['title'].'</b></h4>';
						echo '<p><b>Vacancy: </b>'.$row['vacno'].'<b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Experience: </b>'.$row['experience'].'yr&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="companyresponse.php?id='.$row['jobid'].'"><b>View Applications </b>&nbsp;&nbsp;<a style="float:right;" href="deletepost.php?id='.$row['jobid'].'"><b>Delete Post</b></p>';
						echo '</a></div><br>';
					}
				}
			?>
